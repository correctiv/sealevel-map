<sealevel-scrolly-header class="scrolly__header" id="main">
  ...
  <div class="container">
    <div class="scrolly__header__content">
      ...
      <div class="scrolly__header__sidebar">

        <div class="scrolly__header__authors">
        ...
        <div class="scrolly__header__partners">
      ...
      <div class="scrolly__header__body">
      ...
      <div class="scrolly__header__body" ref="body"></div>
  ...
  <script type="text/babel">
    this.on('update', () => {
      ...
      const body = require(`../../../locale/${lang}/header.md`)
